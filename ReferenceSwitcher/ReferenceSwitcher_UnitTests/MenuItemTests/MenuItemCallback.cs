...
namespace ReferenceSwitcher_UnitTests.MenuItemTests
{
    using PubliWeb.Tools.ReferenceSwitcher;
    ...
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new ReferenceSwitcherPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(GuidList.guidReferenceSwitcherCmdSet, (int)PkgCmdIDList.cmdidSwitchToProjectReferences);
