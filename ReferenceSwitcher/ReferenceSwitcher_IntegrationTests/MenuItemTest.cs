...
namespace ReferenceSwitcher_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(GuidList.guidReferenceSwitcherCmdSet, (int)PkgCmdIDList.cmdidSwitchToProjectReferences);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ReferenceSwitcher", "RufInformatikAG.ReferenceSwitcher.ReferenceSwitcherPackage");
